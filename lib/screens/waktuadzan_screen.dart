            ...
            child: CustomScrollView(
              slivers: [
                ...
                SliverToBoxAdapter(
                  ...
                  child: Text(
                    "جميع أوقات الأذان في شهور $timeNow",
                      ...
                      child: ListTile(
                        ...
                        onTap: () => NotificationAlertsWidget(
                            ...
                            .showNotificationAlertsAdzanWidget(
                                context,
                                "وقت المساء: ${snapshot.data?[index].imsyak}",
                                "وقت الصباح : ${snapshot.data?[index].shubuh}",
                                "وقت الضحى: ${snapshot.data?[index].dhuha}",
                                "وقت الضهر : ${snapshot.data?[index].dzuhur}",
                                "وقت العصر : ${snapshot.data?[index].ashr}",
                                "وقت المغرب : ${snapshot.data?[index].magrib}",
                                "وقت العشاء${snapshot.data?[index].isya}"),
                        title: Text("تاريخ : ${snapshot.data![index].tanggal}"),
